...
static spi_t spis[] = {  // One for each SPI.
    {
        .hw_inst = CONFIG_SD_SPI_PORT,  // SPI component
        .miso_gpio = CONFIG_SD_SPI_MISO_PIN,
        .mosi_gpio = CONFIG_SD_SPI_MOSI_PIN,
        .sck_gpio = CONFIG_SD_SPI_SCK_PIN,
...
static sd_card_t sd_cards[] = {  // One for each SD card
    {
        ...
        .ss_gpio = CONFIG_SD_SPI_CS_PIN,            // The SPI slave select GPIO for this SD card
