...
/* RAM */
#ifdef EXT_SDRAM
__no_init BYTE RAM[ RAM_SIZE ]@0xD00B5800;
#else
BYTE RAM[ RAM_SIZE ];
#endif
...
/* SRAM */
#ifdef EXT_SDRAM
//__no_init BYTE SRAM[ SRAM_SIZE ]@0xD00B7800;
#else
BYTE SRAM[ SRAM_SIZE ];
#endif
...
/* PPU RAM */
#ifdef EXT_SDRAM
__no_init BYTE PPURAM[ PPURAM_SIZE ]@0xD00AD800;
#else
...
#ifdef EXT_SDRAM
__no_init WORD WorkFrame[ NES_DISP_WIDTH * NES_DISP_HEIGHT ]@0xD0065800;
#else
...
/* Character Buffer */
#ifdef EXT_SDRAM
__no_init BYTE ChrBuf[ 256 * 2 * 8 * 8 ]@0xD009D800;
#else
